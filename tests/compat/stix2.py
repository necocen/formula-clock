...
ap.add_argument('--output-dir',type=Path,default=R/'test-results/compat/stix2')
args=ap.parse_args()
...
with sync_playwright() as p:
 ...
 page.set_content((R/'dist/standalone/index.html').read_text(),wait_until='domcontentloaded')
