...
const messages = {
  ...
  shortcuts: {
    ja: '← → 一時停止中に1秒移動 / Space 一時停止・現在時刻へ / L 現在時刻へ / M 時報 / F 全画面',
    en: '← → Step 1 second while paused / Space Pause or return to current time / L Current time / M Sound / F Fullscreen',
  },
  ...
  shareHelp: {
    ja: 'このURLをコピーして共有できます。',
    en: 'Copy this link to share the current view.',
  },
  shareUrl: { ja: '共有URL', en: 'Share link' },
  shareCopied: { ja: '共有URLをコピーしました', en: 'Share link copied' },
  shareFailed: {
    ja: '共有リンクを作成できませんでした。もう一度お試しください。',
    en: 'Could not create the share link. Please try again.',
  },
  shareNative: { ja: '共有する', en: 'Share' },
  shareCopy: { ja: 'リンクをコピー', en: 'Copy link' },
  shareUnavailable: { ja: '共有リンクを開けませんでした', en: 'Could not open this share link' },
  shareNotFound: {
    ja: 'リンクが見つかりません。作成直後の場合は、少し待ってから再読み込みしてください。',
    en: 'This link was not found. If it was just created, wait a moment and reload.',
  },
  shareLoadFailed: {
    ja: '共有データを読み込めませんでした。少し待ってから再読み込みしてください。',
    en: 'Could not load the saved view. Wait a moment and reload.',
  },
  ...
  fullscreenFailed: {
    ja: '全画面表示に切り替えられませんでした',
    en: 'Could not switch fullscreen mode',
  },
  ...
  clockTime: {
    ja: '{hours}時{minutes}分{seconds}秒',
  ...
  typesettingFailed: {
    ja: '組版を読み込めなかった。通常の時計を表示中。',
    en: 'Could not load the formula display. Showing the clock.',
  },
  formulaFailed: {
    ja: 'この式を組版できなかった。通常の時計を表示中。',
    en: 'Could not display this formula. Showing the clock.',
  },
  loadingData: { ja: 'Loading', en: 'Loading formula data.' },
  dataClockFallback: {
    ja: '式データを読み込めなかった。通常の時計を表示中。',
    en: 'Could not load formula data. Showing the clock.',
  },
...
function create(language: unknown) {
