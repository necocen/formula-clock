...
(() => {
  ...
  class TimeSignal {
    constructor() { this.ctx = null; this.master = null; this.enabled = false; this.volume = .25; this.scheduled = new Map(); this.voices = new Set(); }
    async toggle() {
      ...
      try {
        ...
        this.enabled = true; this.paint(); this.tone(1000, this.ctx.currentTime + .02, .15, .28);
