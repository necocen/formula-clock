...
parser.add_argument('--render-results', type=Path, default=ROOT/'test-results/og/render-results.json')
args = browser_args(parser, __file__, browsers=('chromium', 'firefox', 'webkit'))
